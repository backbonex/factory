define([
    ...
    var SelectorsFactory = Factory.extend(/**@lends SelectorsFactory */{
         ...
         * @returns {SelectorsFactory}
         */
        addProduct: function (productType, Constructor, selector) {
            this._addProductDescriptor(Constructor, productType, selector);
            return this;
        },
         ...
         * @protected
         */
        _addProductDescriptor: function (Constructor, productType, selector) {
            ...
            if (!selector) {
                var self = this;
                selector = productType == '*' ? '*' : descriptor.getTypes().reduce(function (selector, type) {
